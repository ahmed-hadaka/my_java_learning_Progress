...
public class Sets_and_HashSet {
    ...
    public static void main(String[] args) {
        ...
        if (set1.contains("aardvark")) { // false
            System.out.println("Contains aardvark");
        }

        if (set1.contains("cat")) { // true
        ...
        intersection.retainAll(set2); // retain all common objects
        ...
        difference.removeAll(set1); // remove all common objects
