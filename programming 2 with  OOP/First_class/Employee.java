...
public Employee(int id, String n) {      //constructor 2 with overloading
    Emp_ID = id;
    Name = n;
    num_of_objects++;
}

public Employee(int id, String n, boolean res) {         //constructor 3 with overloading and constructor chaining
    this(id, n);  
    Resident = res;
    num_of_objects++;
}

public Employee(int id, String n, String dep, double s, double b, boolean res) {       //constructor 4 with overloading and constructor chaining
    this(id, n, res);
    Depart = dep;
    Salary = s;
    Bonus = b;
